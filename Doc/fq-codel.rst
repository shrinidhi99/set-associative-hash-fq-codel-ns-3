...
Essentially, it makes the queue management system more efficient. Our idea is a 
vital component of CAKE, which is another popular flow management algorithm that 
is also implemented in Linux and is being tested for FqCodel. Furthermore, 
this module can be directly used with CAKE when it is implemented. 
