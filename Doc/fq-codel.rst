...
statements added to the fq-codel-queue-disc.cc file. 30 such trials were conducted 
taking as input 30 different hash data sets and then the average was calculated 
through the use of the spreadsheet. The averages of both were calculated and 
the graph was plotted using spreadsheet tools. 
