...
queues, set-associative hash has fewer collisions in comparison to traditional 
...
* ``SetAssociativeHash:`` The parameter used to enable set associative hash.
...
The steps to replicate this graph can be found here(https://github.com/AB261/Set-Associative-Hash-fqCodel)
